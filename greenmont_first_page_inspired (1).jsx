...
const makeApartment = (id, number, title, area, floor, view, terrace, format, text, accent, gradient) => ({
  id,
  number,
  title,
  area,
...
const toMedia = (path) => `${MEDIA_BASE}/${path}`;

const HERO_ASSETS = {
  cinematic: toMedia('hero/hero-aerial-sunset-master.webp'),
  editorial: toMedia('hero/hero-dusk-facade-pool.webp'),
  gallery: toMedia('hero/hero-sunset-terrace-master.webp'),
  catalog: toMedia('hero/hero-secondary-promenade.webp'),
};

const STORY_ASSETS = {
  metrics: toMedia('story/story-aerial-overall-complex.webp'),
  concept: toMedia('story/story-close-facade-terraces.webp'),
  'private-resort': toMedia('hero/hero-dusk-facade-pool.webp'),
  promenade: toMedia('hero/hero-secondary-promenade.webp'),
  beach: toMedia('hero/hero-sunset-terrace-master.webp'),
  bridges: toMedia('story/story-main-entrance-dropoff.webp'),
  'five-senses': toMedia('story/story-garden-promenade-facade.webp'),
  'art-park': toMedia('gallery/gallery-brand-mood-artwork.webp'),
  'evening-light': toMedia('gallery/gallery-evening-promenade-lights.webp'),
  gazebos: toMedia('story/story-sunset-dining.webp'),
  amphitheater: toMedia('gallery/gallery-title-cover-01.webp'),
  'kids-concept': toMedia('story/story-kids-play-zone.webp'),
  'play-hub': toMedia('story/story-kids-play-zone.webp'),
  'game-center': toMedia('story/story-kids-water-area-family-pool.webp'),
  'creative-studios': toMedia('gallery/gallery-title-card.webp'),
  'cinema-zone': toMedia('gallery/gallery-scenic-mood-01.webp'),
  service: toMedia('story/story-concierge-greeting.webp'),
  transport: toMedia('story/story-electric-cart-mobility.webp'),
  wellness: toMedia('story/story-spa-collage.webp'),
  'medical-center': toMedia('story/story-sauna.webp'),
  'body-mind': toMedia('story/story-yoga-stretch-room.webp'),
  sports: toMedia('story/story-tennis-court-exterior-route.webp'),
  'technology-intro': toMedia('story/story-main-entrance-dropoff.webp'),
  lifts: toMedia('gallery/gallery-blue-lobby-stair-mood.webp'),
  parking: toMedia('story/story-main-entrance-dropoff.webp'),
  engineering: toMedia('story/story-location-map.webp'),
  security: toMedia('story/story-business-checkin-mood.webp'),
  soundproofing: toMedia('apartments/shared/shared-bedroom-sunset.webp'),
  location: toMedia('story/story-location-map.webp'),
  'team-interiors': toMedia('apartments/shared/shared-luxury-suite-living-room.webp'),
  'team-landscape': toMedia('story/story-garden-promenade-facade.webp'),
  'team-hotelier': toMedia('story/story-concierge-greeting.webp'),
  'team-architecture': toMedia('story/story-aerial-overall-complex.webp'),
  'interiors-transition': toMedia('apartments/shared/shared-penthouse-exteriors.webp'),
  gallery: toMedia('gallery/gallery-pool-collage.webp'),
  'pricing-cta': toMedia('gallery/gallery-title-card.webp'),
  route: toMedia('story/story-location-map.webp'),
  'contact-story': toMedia('story/story-business-checkin-mood.webp'),
  'footer-story': toMedia('gallery/gallery-scenic-mood-02.webp'),
};

const APARTMENT_ASSETS = {
  'apartment-01': {
    main: toMedia('apartments/shared/shared-indoor-outdoor-sea-suite.webp'),
    interior: toMedia('apartments/shared/shared-bedroom-sunset.webp'),
    terrace: toMedia('apartments/shared/shared-terrace-dusk-lifestyle.webp'),
    plan: null,
  },
  'apartment-02': {
    main: toMedia('apartments/shared/shared-luxury-suite-living-room.webp'),
    interior: toMedia('apartments/shared/shared-bedroom-suite-collage.webp'),
    terrace: toMedia('apartments/shared/shared-sea-view-between-buildings.webp'),
    plan: null,
  },
  'apartment-03': {
    main: toMedia('apartments/shared/shared-penthouse-exteriors.webp'),
    interior: toMedia('apartments/shared/shared-bedroom-suite-collage.webp'),
    terrace: toMedia('apartments/shared/shared-terrace-dusk-lifestyle.webp'),
    plan: null,
  },
  'apartment-04': {
    main: toMedia('apartments/shared/shared-sea-view-between-buildings.webp'),
    interior: toMedia('apartments/shared/shared-bed-sea-view.webp'),
    terrace: toMedia('apartments/shared/shared-indoor-outdoor-sea-suite.webp'),
    plan: null,
  },
  'apartment-05': {
    main: toMedia('apartments/shared/shared-penthouse-exteriors.webp'),
    interior: toMedia('apartments/shared/shared-luxury-suite-living-room.webp'),
    terrace: toMedia('apartments/shared/shared-terrace-dusk-lifestyle.webp'),
    plan: null,
  },
  'apartment-06': {
...
const getStoryAsset = (id) => STORY_ASSETS[id] || toMedia('gallery/gallery-scenic-mood-01.webp');
...
function StoryHeader({ item, theme, format }) {
  return (
    <div className={format.maxTextWidth}>
      <div className="flex items-center gap-4 text-[11px] uppercase" style={{ color: theme.accent, letterSpacing: theme.eyebrowSpacing }}>
      ...
      <div className="mt-8 border-l pl-6 text-base leading-8" style={{ borderColor: theme.accent, color: theme.muted, letterSpacing: theme.bodySpacing }}>
        {item.text}
      </div>
      <div className="mt-7 inline-flex rounded-full border px-4 py-2 text-[12px] uppercase" style={{ borderColor: theme.accent, background: theme.accentSoft, color: theme.accent, letterSpacing: '0.22em' }}>
...
function ParallaxPanel({ scrollY, speed, item, theme, format, height, asset }) {
  ...
  return (
    <div className={`relative overflow-hidden rounded-[2.3rem] border ${height}`} style={{ borderColor: theme.border }}>
      <div
        ...
        style={{
          backgroundImage: hasAsset ? `url(${asset}), ${item.gradient}` : item.gradient,
          backgroundSize: 'cover, cover',
          backgroundPosition: 'center, center',
          backgroundRepeat: 'no-repeat, no-repeat',
          transform: `translate3d(0, ${scrollY * speed * format.parallaxBoost}px, 0) scale(${format.mediaEmphasis})`,
          willChange: 'transform',
        }}
      />
      <div className="absolute inset-0" style={{ background: `radial-gradient(circle at top, rgba(255,255,255,0.18), transparent 28%), linear-gradient(180deg, transparent, ${theme.panel})` }} />
      <div className="relative z-10 flex h-full flex-col justify-end p-6 md:p-8 lg:p-10">
        <div className="max-w-3xl rounded-[1.8rem] border p-6 backdrop-blur-md" style={{ borderColor: theme.border, background: theme.panel }}>
          ...
          {hasAsset && (
            <div className="mt-4 text-[10px] uppercase" style={{ color: theme.subtle, letterSpacing: '0.24em' }}>
              путь ассета: {asset.replace('/media/', '')}
            </div>
          )}
        </div>
      </div>
...
function StorySection({ item, index, scrollY, theme, format }) {
  const reverse = index % 2 === 1;
  const sectionBackground = index % 3 === 1 ? theme.backgroundAlt : theme.background;
  const height = format.id === 'gallery' ? 'min-h-[78vh]' : format.id === 'catalog' ? 'min-h-[54vh]' : format.sectionMediaHeight;
  const asset = getStoryAsset(item.id);
  return (
    <section id={item.id} className="py-20 lg:py-28" style={{ backgroundColor: sectionBackground, borderTop: index % 3 === 1 ? `1px solid ${theme.border}` : 'none', borderBottom: index % 3 === 1 ? `1px solid ${theme.border}` : 'none' }}>
      <div className="mx-auto max-w-[1600px] px-6 lg:px-10">
        <div className={`grid items-start gap-10 ${format.storyCols} lg:gap-14 ${reverse ? 'lg:grid-flow-col-dense' : ''}`}>
          <div className={reverse ? 'lg:order-2' : ''}>
            ...
            {format.id === 'editorial' && (
              <div className="mt-8 max-w-xl rounded-[1.6rem] border p-5 text-sm leading-7" style={{ borderColor: theme.border, background: theme.surface, color: theme.muted }}>
                {theme.description}
              </div>
            )}
          </div>
          <div className={reverse ? 'lg:order-1' : ''}>
            <ParallaxPanel scrollY={scrollY} speed={0.05 + (index % 4) * 0.02} item={item} theme={theme} format={format} height={height} asset={asset} />
          </div>
        </div>
      </div>
    </section>
...
function ApartmentSection({ item, index, scrollY, theme, format }) {
  ...
  const cards = [
    ...
    ...(format.id === 'gallery'
      ? [{ title: 'Планировка', text: media.plan ? 'Схема и логика сценария проживания' : 'Планировка будет добавлена после загрузки отдельного файла', image: media.plan }]
      : []),
  ];

  return (
    <section id={item.id} className="py-18 lg:py-22" style={{ backgroundColor: index % 2 === 0 ? theme.backgroundAlt : theme.background, borderTop: index % 2 === 0 ? `1px solid ${theme.border}` : 'none', borderBottom: index % 2 === 0 ? `1px solid ${theme.border}` : 'none' }}>
      <div className="mx-auto max-w-[1600px] px-6 lg:px-10">
        <div className={`grid items-start gap-8 ${format.apartmentCols} lg:gap-12`}>
          <div>
            ...
            <h3
              ...
              style={{ fontFamily: theme.headingFont, letterSpacing: theme.headingSpacing, color: theme.text, fontStyle: theme.headingStyle, fontWeight: 400 }}
            >
              {item.title}
            </h3>
            ...
            <div className={`mt-7 grid gap-3 ${format.id === 'catalog' ? 'sm:grid-cols-2' : 'grid-cols-1'}`}>
              {specs.map((spec) => (
                <div key={spec.label} className="rounded-full border px-4 py-2 text-[12px] uppercase" style={{ borderColor: theme.accent, background: theme.accentSoft, color: theme.accent, letterSpacing: '0.18em' }}>
                  {spec.label}: {spec.value}
                </div>
              ))}
            </div>
            <div className="mt-8 rounded-[1.8rem] border p-5" style={{ borderColor: theme.border, background: theme.surface }}>
              <div className="text-[11px] uppercase" style={{ color: theme.accent, letterSpacing: theme.eyebrowSpacing }}>стоимость</div>
              <div className="mt-3 text-[1.9rem] leading-[1]" style={{ fontFamily: theme.headingFont, letterSpacing: theme.headingSpacing, color: theme.text, fontStyle: theme.headingStyle, fontWeight: 400 }}>
                Цена по запросу
              </div>
              ...
              <div className="mt-5 flex flex-wrap gap-3">
                <a
                  ...
                  style={{ backgroundColor: theme.accent, color: theme.buttonText, boxShadow: `0 10px 30px ${theme.accentSoft}` }}
                >
          ...
          <div className="overflow-hidden rounded-[2.2rem] border shadow-[0_20px_80px_rgba(0,0,0,0.24)]" style={{ borderColor: theme.border, background: theme.surfaceStrong, transform: `translate3d(0, ${offset}px, 0)` }}>
            <div
              className={format.id === 'gallery' ? 'aspect-[16/11]' : 'aspect-[5/4]'}
              style={{
                backgroundImage: media.main ? `url(${media.main}), ${item.gradient}` : item.gradient,
                backgroundSize: 'cover, cover',
                backgroundPosition: 'center, center',
                backgroundRepeat: 'no-repeat, no-repeat',
              }}
            ...
            <div className={`grid gap-4 p-6 ${format.id === 'gallery' ? 'md:grid-cols-4' : 'md:grid-cols-3'}`}>
              {cards.map((block) => (
                <div key={block.title} className="rounded-[1.4rem] border p-4" style={{ borderColor: theme.border, background: theme.surface }}>
                  <div
                    className="mb-3 aspect-[4/3] rounded-[1rem] border"
                    style={{
                      borderColor: theme.border,
                      backgroundImage: block.image ? `url(${block.image}), ${item.gradient}` : item.gradient,
                      backgroundSize: 'cover, cover',
                      backgroundPosition: 'center, center',
                      backgroundRepeat: 'no-repeat, no-repeat',
                    }}
                  />
                  <div className="text-[11px] uppercase" style={{ color: theme.accent, letterSpacing: theme.eyebrowSpacing }}>медиаблок</div>
                  <div className="mt-3 text-sm font-medium leading-6" style={{ color: theme.text }}>{block.title}</div>
                  <div className="mt-2 text-sm leading-6" style={{ color: theme.muted }}>{block.text}</div>
                  {block.image && (
                    <div className="mt-3 text-[10px] uppercase" style={{ color: theme.subtle, letterSpacing: '0.24em' }}>
                      {block.image.replace('/media/', '')}
                    </div>
                  )}
                </div>
              ))}
...
export default function GreenmontLuxurySite() {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none fixed inset-0 [background-image:linear-gradient(rgba(255,255,255,0.65)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.65)_1px,transparent_1px)] [background-size:120px_120px]" style={{ opacity: theme.id.includes('ivory') || theme.id.includes('pearl') || theme.id.includes('sand') ? 0.025 : 0.04 }} />
      <div className="pointer-events-none fixed inset-0" style={{ background: `radial-gradient(circle at top, ${theme.accentSoft}, transparent 22%), radial-gradient(circle at 80% 10%, rgba(255,255,255,0.05), transparent 18%)` }} />
      ...
      <header className="sticky top-0 z-50 border-b backdrop-blur-2xl" style={{ borderColor: theme.border, background: theme.header }}>
        <div className="mx-auto flex max-w-[1600px] items-center justify-between px-6 py-5 lg:px-10">
          <div>
            <div className="text-[11px] uppercase" style={{ color: theme.accent, letterSpacing: theme.eyebrowSpacing }}>Greenmont</div>
          ...
          <nav className="hidden items-center gap-3 xl:flex">
            {navItems.map((item) => (
              <a
                ...
                style={{ borderColor: theme.border, background: theme.surface, color: theme.muted, letterSpacing: '0.24em' }}
              >
                {item.label}
              </a>
            ))}
      ...
      <section className="border-b py-8" style={{ borderColor: theme.border, backgroundColor: theme.backgroundAlt }}>
        <div className="mx-auto grid max-w-[1600px] gap-6 px-6 lg:grid-cols-[1fr_1fr] lg:px-10">
          <div className="rounded-[2rem] border p-5" style={{ borderColor: theme.border, background: theme.surface }}>
            <div className="text-[11px] uppercase" style={{ color: theme.accent, letterSpacing: theme.eyebrowSpacing }}>Выбор цветовой схемы</div>
          ...
          <div className="rounded-[2rem] border p-5" style={{ borderColor: theme.border, background: theme.surface }}>
            <div className="text-[11px] uppercase" style={{ color: theme.accent, letterSpacing: theme.eyebrowSpacing }}>Выбор визуального формата</div>
            <div className="mt-3 text-[1.7rem] leading-[1]" style={{ fontFamily: theme.headingFont, letterSpacing: theme.headingSpacing, fontStyle: theme.headingStyle }}>
              Несколько визуальных форматов для одной и той же истории
            </div>
            <p className="mt-3 text-sm leading-7" style={{ color: theme.muted, letterSpacing: theme.bodySpacing }}>
              Можно переключать способ подачи: более кинематографично, более редакционно, более галерейно или более структурно-каталожно. Пути к реальным файлам уже проставлены в коде и ожидаются в папке /public/media/.
            </p>
      ...
      <main>
        <section id="hero" className="relative overflow-hidden border-b" style={{ borderColor: theme.border, backgroundColor: theme.background }}>
          <div
            className="absolute inset-[-10%]"
            style={{
              backgroundImage: `url(${heroAsset}), ${STORY_SECTIONS[0].gradient}`,
              backgroundSize: 'cover, cover',
              backgroundPosition: 'center, center',
              backgroundRepeat: 'no-repeat, no-repeat',
          ...
          />
          <div className="absolute inset-0" style={{ background: `radial-gradient(circle at top, rgba(255,255,255,0.22), transparent 26%), linear-gradient(180deg, transparent, ${theme.panel})` }} />
          ...
          <div className={`relative z-10 mx-auto flex ${format.heroMinHeight} max-w-[1600px] flex-col justify-between px-6 pb-10 pt-24 lg:px-10 lg:pb-14 lg:pt-28`}>
            <div className="flex items-start justify-between gap-6">
              ...
              <div className="hidden items-center gap-3 text-[11px] uppercase lg:flex" style={{ color: theme.subtle, letterSpacing: '0.36em' }}>
                <span className="h-px w-16" style={{ backgroundColor: theme.accent }} />
                {format.name.toLowerCase()} · {heroAsset.replace('/media/', '')}
              </div>
            </div>
            ...
            <div className={`grid items-end gap-10 pb-6 pt-16 ${format.id === 'gallery' ? 'lg:grid-cols-[0.9fr_1.1fr]' : 'lg:grid-cols-[1.08fr_0.92fr]'} lg:pt-20`}>
              <div>
                ...
                <div className="mt-10 flex flex-wrap gap-4">
                  <a href="#apartment-01" className="rounded-full px-7 py-3.5 text-sm font-semibold tracking-[0.05em] transition hover:translate-y-[-1px]" style={{ backgroundColor: theme.accent, color: theme.buttonText, boxShadow: `0 10px 40px ${theme.accentSoft}` }}>
                    Смотреть 8 апартаментов
                  </a>
                  <a href="#final-contact" className="rounded-full border px-7 py-3.5 text-sm font-semibold tracking-[0.05em] transition" style={{ borderColor: theme.border, background: theme.surface, color: theme.text }}>
              ...
              <div className={`grid gap-4 ${format.id === 'gallery' ? 'sm:grid-cols-2 xl:grid-cols-2' : 'sm:grid-cols-2 xl:grid-cols-3'}`}>
                {METRICS.map((item, index) => (
                  ...
                  >
                    ...
                    <div className="mt-1 text-sm" style={{ color: theme.subtle, letterSpacing: theme.bodySpacing }}>{item.label}</div>
                  </div>
                ))}
              </div>
            </div>
        ...
        {STORY_SECTIONS.slice(1).map((item, index) => (
          <StorySection key={item.id} item={item} index={index} scrollY={scrollY} theme={theme} format={format} />
        ))}
        ...
        {APARTMENTS.map((item, index) => (
          <ApartmentSection key={item.id} item={item} index={index} scrollY={scrollY} theme={theme} format={format} />
        ))}

        {FINAL_SECTIONS.map((item, index) => (
          <StorySection key={item.id} item={item} index={index + STORY_SECTIONS.length} scrollY={scrollY} theme={theme} format={format} />
        ))}
          ...
          <div className="mx-auto grid max-w-[1600px] gap-10 px-6 lg:grid-cols-[0.96fr_1.04fr] lg:px-10">
            ...
            <div className="rounded-[2.2rem] border p-6 shadow-[0_20px_80px_rgba(0,0,0,0.22)] md:p-8 lg:p-9" style={{ borderColor: theme.border, background: theme.surfaceStrong }}>
              <div className="mb-6 border-b pb-5" style={{ borderColor: theme.border }}>
                <div className="text-[11px] uppercase" style={{ color: theme.accent, letterSpacing: theme.eyebrowSpacing }}>персональный запрос</div>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <input className="rounded-2xl border px-4 py-3.5 outline-none transition" style={{ borderColor: theme.border, background: theme.surface, color: theme.text }} placeholder="Ваше имя" />
                <input className="rounded-2xl border px-4 py-3.5 outline-none transition" style={{ borderColor: theme.border, background: theme.surface, color: theme.text }} placeholder="Телефон" />
              </div>
              <textarea className="mt-4 min-h-[130px] w-full rounded-2xl border px-4 py-3.5 outline-none transition" style={{ borderColor: theme.border, background: theme.surface, color: theme.text }} placeholder="Укажите интересующий апартамент или сценарий владения" />
              <div className="mt-5 flex flex-wrap items-center gap-4">
                <button className="rounded-full px-6 py-3 text-sm font-semibold tracking-[0.05em]" style={{ backgroundColor: theme.accent, color: theme.buttonText }}>
                  Отправить заявку
                </button>
                <div className="text-xs leading-6" style={{ color: theme.subtle }}>Персональный подбор, презентация, private viewing.</div>
              </div>
            </div>
          </div>
        </section>
